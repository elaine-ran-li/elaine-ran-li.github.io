...
Using the Web3 industry as a primary empirical context, my current research examines how digital ventures can leverage emergent fashionable digital technologies to gain investor support in nascent markets. In other works, I investigate how technical designs on open innovation platforms (e.g., blockchain and crowdsourcing platforms), such as platform compatibility and code-forking features, influence the strategic outcomes for both platform users and owners.
