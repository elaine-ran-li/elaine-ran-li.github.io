...
Using the Web3 industry as a primary empirical context, my current research examines how digital ventures can leverage emergent fashionable digital technologies to gain investor support in nascent markets. I analyzed large-scale social media (X) data and smart contract code, employing LLM-based content analysis to identify and encode technical engagement behaviors. In other works, I investigate how technical designs on open innovation platforms (e.g., blockchain and crowdsourcing platforms), including platform compatibility and code-forking features, influence the strategic outcomes for both platform users and owners.
...
<strong>I will be joining the College of Business at City University of Hong Kong (as Research Assistant Professor) in 2026 Fall.</strong>
